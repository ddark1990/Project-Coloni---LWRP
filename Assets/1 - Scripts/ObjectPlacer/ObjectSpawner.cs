...
public class ObjectSpawner : MonoBehaviour
{
    ...
    public ObjectSpawnerDataset objectSpawnerDataset;
    ...
    public void PlaceRandomObjects()
    {
        ...
        {
            for (int z = 0; z < objectSpawnerDataset.objectsToPlace.Count; z++)
            {
                var rndIndex = Random.Range(0, objectSpawnerDataset.objectsToPlace.Count);
                var randomObj = objectSpawnerDataset.objectsToPlace[rndIndex];
