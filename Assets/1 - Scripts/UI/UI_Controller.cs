...
namespace ProjectColoni
{
    public class UI_Controller : MonoBehaviour
    {
        ...
        public UI_ColonistPanel colonistPanel;
        ...
        {
            var aiController = SelectionManager.LastSelectedObject.GetComponentInChildren<AiController>();
        ...
        {
            var resource = SelectionManager.LastSelectedObject.GetComponentInChildren<Node>();
        ...
        {
            var item = SelectionManager.LastSelectedObject.GetComponentInChildren<Item>();
        ...
        {
            if(SelectionManager.HoveringObject == null) UIView.HideViewCategory("General");
